function getLogedInHeaderTemplate() {
    return /*html*/ `<img onclick="toggleOpen(this); stopProp(event)" closable="true" open="false" class="profile_img_small" src="${getPersonImgPath(currentUser.file)}" alt="Profilbild">
